<%@ Page Title="Iniciar sesión" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="UsuarioLogin.aspx.cs" Inherits="Condeco.UsuarioLogin" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <p>
        ...
        <asp:HyperLink ID="RegisterHyperLink" runat="server" EnableViewState="false" NavigateUrl="~/UsuarioRegister.aspx" >Registrarse</asp:HyperLink> si no tiene una cuenta.
    </p>
