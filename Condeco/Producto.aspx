                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="1000px" style="padding: 20px">
                                            ...
                                            <tr>
                                                <td colspan="5" align="right" style="height: 24px; padding-top: 20px; text-align: center">
                                                    <asp:Button ID="BuscarButton" runat="server" TabIndex="8" Text="Aplicar filtro" ToolTip="Muestra los productos acorde a los filtros seleccionados"
                                                        OnClick="BuscarButton_Click" UseSubmitBehavior="false" />
                                                    <asp:Button ID="ClearButton" runat="server" TabIndex="8" Text="Limpiar filtro" ToolTip="Muestra todos los productos"
                                                        OnClick="ClearButton_Click" UseSubmitBehavior="false" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="5">
                                                    <table border="0" cellpadding="0" cellspacing="0" style="padding-left: 10px; padding-bottom: 10px;
                                                        width: 100%">
                                                        <tr>
                                                        ...
                                                        <cc1:PagingGridView ID="ProductoPagingGridView" runat="server" OnPageIndexChanging="ProductoPagingGridView_PageIndexChanging"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="Nombre" HeaderText="Nombre" SortExpression="Nombre" HeaderStyle-Width="200px">
                                                                    ...
                                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="false" CssClass="TextDecorationNone"
                                                                        BorderColor="Gray" ForeColor="Black" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="Descripcion" HeaderText="Descripción" SortExpression="Descripcion">
                                                                    <HeaderStyle HorizontalAlign="Center" Wrap="false" Width="100%" BackColor="white" />
                                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="true" CssClass="TextDecorationNone"
                                                                        BorderColor="Gray" ForeColor="Black" />
                                                                </asp:BoundField>
                                                            </Columns>
                                                                            ...
                                                                            <table border="0">
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="vertical-align: top">
                                                                                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("DescripcionCorta") %>' Width="280px"
