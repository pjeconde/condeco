                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="panel panel-default" style="">
                        <div class="panel-body">
                            ...
                            <div class="row">
                                        <asp:Button ID="AceptarButton" runat="server" CssClass="btn btn-info" OnClick="AceptarButton_Click" TabIndex="4"
                                            Text="Solicitar Nombre de Usuario" OnClientClick="BorrarMensaje()"
                                            UseSubmitBehavior="false" />
                                        <asp:Button ID="CancelarButton" runat="server" CssClass="btn btn-info" CausesValidation="false" PostBackUrl="~/UsuarioLogin.aspx"
