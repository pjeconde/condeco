...
namespace CondecoEX
{
	...
	{
		private string m_LogName = System.IO.Path.GetTempPath()  + "TangoErrorLog.txt";
		...
		void IExceptionPublisher.Publish(Exception exception, NameValueCollection AdditionalInfo, NameValueCollection ConfigSettings)
		{
			...
			if (m_OpMail.Length > 0)
			{
                ...
                mail = new System.Net.Mail.MailMessage(System.Configuration.ConfigurationManager.AppSettings["MailCredencialesUsr"], m_OpMail, subject, body);
